...
4. [[domains/AI Agent工程/03-Skill设计/04-可分享跨Agent Skill创建方法|可分享跨 Agent Skill 创建方法]]
5. [[domains/AI Agent工程/90-Skill注册表/01-个人与项目Skill注册库|个人/项目 Skill 注册库]]
6. [[domains/AI Agent工程/90-Skill注册表/02-跨Agent Skill注册库|跨 Agent Skill 注册库]]
...
- 如果是创建、更新、审查或测试一般 Agent skill，默认以用户自己的 `portable-skill-creator` 为入口；只有用户明确要求单独使用系统内置 `skill-creator` 时才跳过 portable 扩展。
...
- 可分享 skill 必须通过隐私/机器依赖扫描；平台专属 metadata 和路径不得成为核心工作流的必要条件。
