...
| Source area | Formal representation | Disposition | Notes |
| --- | --- | --- | --- |
| 15 个 skill 的一级结构 | source-inventory.md | formalized | 用于定位原始案例。 |
| 通用执行规则 | core-rules.md | formalized | 跨 skill 抽取。 |
| 工具与参数 | tool-specs.md | formalized | 与 Skill 生成器规则合并。 |
| 高频任务模式 | task-patterns.md | formalized | 按未来写作路由重组。 |
