...
本书 TOC 78 条，已映射到 46 个章节文件。章节级清单见 `chapter-inventory.md`，知识单元级覆盖见 `knowledge-unit-inventory.md` 与 `coverage-matrix.md`。

## 核心素材类型

- 方法论：品牌视觉、产品视觉、营销视觉三分法；差异化与统一；一米宽一千米深。
- 经营指标：点击率、转化率、复购率、客单价、曝光/展现、销售额公式。
- 组织协作：老板、运营、美工之间的审美标准、职责边界、填空题式标准化。
- 品牌视觉标准：名字、LOGO、SLOGAN、色彩、字体字号、品牌活体、品牌标签、品牌摄影、产品摄影、包装、故事、接触点。
- 案例：卡贝、良品铺子、花笙记、茵曼、裂帛、三只松鼠、阿芙、德力西爱阁、王小帮农家店、御道艾灸盒、脑白金、海底捞等。
