...
1. [[domains/ai-agent-engineering/skill-design/infinite-canvas-skill-writing/core-rules|核心规则]]
2. [[domains/ai-agent-engineering/skill-design/infinite-canvas-skill-writing/tool-specs|工具规范]]
3. [[domains/ai-agent-engineering/skill-design/infinite-canvas-skill-writing/common-pitfalls|常见反坑库]]
4. [[domains/ai-agent-engineering/skill-design/infinite-canvas-skill-writing/quality-checklist|质量检查清单]]

按任务补读：

- 图像/视频/详情页/主图/成套视觉 → [[task-patterns]]
- Prompt 设计 → [[prompt-patterns]]
...
Agent 应优先读取本页面和 index，而不是只查 skill 注册库。
