...
AI 视频 prompt 的目标不是把电影术语堆满，而是把 [[domains/视觉制作/06-AI视频/02-导演思维/03-导演式镜头设计方法|导演式镜头设计方法]] 中的镜头决策，翻译成模型容易执行的短句。
...
- [[domains/视觉制作/06-AI视频/05-视频生成/12-AI视频Prompt分层强控方法|AI视频 Prompt 分层强控方法]]：当 Prompt 越写越长却越不听话时，用硬约束、关键细节、风格控制三层结构和辅助控制资产降低约束竞争。
