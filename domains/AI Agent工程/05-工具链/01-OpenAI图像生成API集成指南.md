...
for event in stream:
    if event.type == "response.image_generation_call.partial_image":
        save_base64_image(f"partial-{event.partial_image_domains/视觉制作/05-小红书风格AI生图/index}.png", event.partial_image_b64)
...
for event in stream:
    if event.type == "image_generation.partial_image":
        with open(f"partial-{event.partial_image_domains/视觉制作/05-小红书风格AI生图/index}.png", "wb") as f:
...
- [[domains/视觉制作/domains/视觉制作/05-小红书风格AI生图/index/domains/视觉制作/05-小红书风格AI生图/index|视觉制作知识域]]
