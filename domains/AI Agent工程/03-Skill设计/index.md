...
- [[domains/AI Agent工程/03-Skill设计/04-可分享跨Agent Skill创建方法|可分享跨 Agent Skill 创建方法]]：以用户拥有的 portable 扩展组合当前基础 creator，隔离平台差异并执行隐私、机器独立和跨 Agent QA。
...
3. [[domains/AI Agent工程/03-Skill设计/04-可分享跨Agent Skill创建方法|可分享跨 Agent Skill 创建方法]]
4. 与目标平台或任务类型相关的具体知识库页面
