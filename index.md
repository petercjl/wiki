...
- [[domains/视觉制作/06-AI视频/02-AI商业短视频规划方法|AI商业短视频规划方法]]：从罐头 Visuals 7 个案例中抽象出产品诊断、案例检索、卖点翻译、人物冲突、分镜图片、导演取舍和 Agent 化输出的商业短视频规划主线。
...
- [[domains/视觉制作/06-AI视频/40-AI短视频故事方法论/03-人物动机阻碍与转变|人物动机阻碍与转变]]：把人物状态、想要、阻碍、代价、关键动作和片尾转变写成可拍字段。
- [[domains/视觉制作/06-AI视频/40-AI短视频故事方法论/04-创意记忆点与传播钩子|创意记忆点与传播钩子]]：用简单、意外、具体、可信、情绪和故事机制设计开头钩子、物件、动作和品牌收束。
- [[domains/视觉制作/06-AI视频/40-AI短视频故事方法论/05-视觉结构与剪辑节奏|视觉结构与剪辑节奏]]：把视觉强度、镜头问题/答案、切点和节奏转成 AI 短视频分镜规则。
- [[domains/视觉制作/06-AI视频/40-AI短视频故事方法论/06-产品营销短视频故事模式库|产品营销短视频故事模式库]]：把 OPPO、五菱、母亲节、意识残留、运动品牌、低度果酒和端午案例抽成可迁移故事模式。
- [[domains/视觉制作/06-AI视频/40-AI短视频故事方法论/07-AI故事到分镜生产工作流|AI故事到分镜生产工作流]]：把故事命题转成视觉事件、镜头问题/答案、分镜字段、首尾帧和声音边界。
- [[domains/视觉制作/06-AI视频/40-AI短视频故事方法论/08-Agent使用模板：AI短视频故事策划|Agent使用模板：AI短视频故事策划]]：给 Agent 完成故事命题、结构、镜头任务、生产交接和质检的标准输出模板。
- [[domains/视觉制作/06-AI视频/25-AI短视频分镜通用能力/index|AI短视频分镜通用能力]]：建设故事大纲转 AI 短视频分镜提示词的通用能力层。
- [[domains/视觉制作/06-AI视频/25-AI短视频分镜通用能力/00-建设路线图|AI短视频分镜知识库建设路线图]]：规划通用分镜能力、影像美学大师风格、五本导演/摄影书籍吸收和 2 分钟短片案例建设顺序。
- [[domains/视觉制作/06-AI视频/25-AI短视频分镜通用能力/01-故事大纲到AI视频分镜的拆解方法|故事大纲到AI视频分镜的拆解方法]]：把 2 分钟故事大纲拆成镜头任务、视觉事件、节奏段落和 AI 可生成镜头。
- [[domains/视觉制作/06-AI视频/25-AI短视频分镜通用能力/02-AI视频镜头字段标准|AI视频镜头字段标准]]：定义 AI 视频镜头 prompt 的时间、任务、主体、动作、景别、构图、运镜、光色、质感、声音台词和连续性字段。
- [[domains/视觉制作/06-AI视频/25-AI短视频分镜通用能力/03-景别与情绪表达|景别与情绪表达]]：把景别、空间压缩、镜头距离和视觉强度映射到孤独、压迫、亲密、犹豫、释然等情绪。
- [[domains/视觉制作/06-AI视频/25-AI短视频分镜通用能力/04-运镜选择方法|运镜选择方法]]：按镜头任务选择揭示、推进、跟随、转角、反向推进、前景遮挡和背景运动等运镜。
- [[domains/视觉制作/06-AI视频/25-AI短视频分镜通用能力/05-光线色彩与质感描述|光线色彩与质感描述]]：把光线、色彩、胶片颗粒、镜头眩光、纪实粗粝和广告精致等质感转成可控 prompt。
- [[domains/视觉制作/06-AI视频/25-AI短视频分镜通用能力/06-人物动作与场景描述方法|人物动作与场景描述方法]]：用人物动作、手部细节、环境动作、前景和关键物件替代抽象情绪描述。
- [[domains/视觉制作/06-AI视频/25-AI短视频分镜通用能力/07-镜头连续性与剪辑衔接|镜头连续性与剪辑衔接]]：检查人物、空间、动作、物件、节奏和剪辑点的连续性。
- [[domains/视觉制作/06-AI视频/25-AI短视频分镜通用能力/08-Agent使用模板：故事大纲转分镜提示词|Agent使用模板：故事大纲转分镜提示词]]：给 Agent 从故事大纲生成台词总表、镜头表和最终 AI 视频 prompt 的标准流程。
- [[domains/视觉制作/06-AI视频/25-AI短视频分镜通用能力/09-AI短视频完整视听分镜Prompt结构|AI短视频完整视听分镜 Prompt 结构]]：把分段视频 prompt 从画面描述升级为包含剧情任务、空间锚点、台词旁白、环境音效、连续性和禁止自由发挥的商业可控结构。
- [[domains/视觉制作/06-AI视频/20-导演知识系统/index|AI视频导演知识系统]]：把 Steven D. Katz 的导演分镜书编译为可视化、故事板、连续性、剪辑、场面调度、移动摄影和 AI 生成扩展能力模块。
- [[domains/视觉制作/06-AI视频/20-导演知识系统/01-导演可视化系统|导演可视化系统]]：把故事意图转成可拍、可画、可生成的镜头任务和观众经验。
- [[domains/视觉制作/06-AI视频/20-导演知识系统/02-视觉设计与故事板系统|视觉设计与故事板系统]]：区分概念图、技术图、连续性草图、故事板和预演工具。
- [[domains/视觉制作/06-AI视频/20-导演知识系统/03-制片周期与AI资产管理|制片周期与 AI 资产管理]]：把制片周期转译为 AI 视频素材、版本、coverage 和复盘管理。
- [[domains/视觉制作/06-AI视频/20-导演知识系统/04-连续性空间系统|连续性空间系统]]：整理景别、轴线、三角机位、视觉识别和空间推理。
- [[domains/视觉制作/06-AI视频/20-导演知识系统/05-剪辑时间系统|剪辑时间系统]]：用问题/答案、camera cutting、coverage、动作剪辑和清空画框组织时间。
- [[domains/视觉制作/06-AI视频/20-导演知识系统/06-镜头流与场景构成系统|镜头流与场景构成系统]]：用景别、机位、细节拼整体和情绪距离设计 shot flow。
- [[domains/视觉制作/06-AI视频/20-导演知识系统/07-人物场面调度系统|人物场面调度系统]]：整理两人、三人、多人和移动人物调度方法。
- [[domains/视觉制作/06-AI视频/20-导演知识系统/08-画面深度、机位与POV系统|画面深度、机位与 POV 系统]]：用前中后景、机位、开闭构图和 POV 控制观众位置。
- [[domains/视觉制作/06-AI视频/20-导演知识系统/09-移动摄影系统|移动摄影系统]]：整理平摇、升降、跟拍和运动镜头编舞的导演任务。
- [[domains/视觉制作/06-AI视频/20-导演知识系统/10-转场画幅收束与AI扩展系统|转场画幅收束与 AI 扩展系统]]：连接转场、画幅、shadowing、捷径、收束和 AI 视频生成工作流。
...
- [[domains/视觉制作/06-AI视频/30-影像美学大师风格AI短视频/01-岩井俊二风格AI短视频制作方法|岩井俊二风格AI短视频制作方法]]：从微信视频号 AI 短视频教程中提炼岩井俊二风格的高密度风格锚点，并提取雨檐少女、教室暗恋、图书馆、稻田、树洞旧信等提示词。
- [[domains/视觉制作/06-AI视频/30-影像美学大师风格AI短视频/02-王家卫风格AI短视频制作方法|王家卫风格AI短视频制作方法]]：把都市霓虹、慢门拖影、镜面反射、手持贴身摄影和错过感转成 AI 短视频分镜 prompt。
- [[domains/视觉制作/06-AI视频/30-影像美学大师风格AI短视频/03-韦斯安德森风格AI短视频制作方法|韦斯安德森风格AI短视频制作方法]]：把对称构图、复古粉彩、舞台化空间、精确横移和怪诞秩序转成 AI 短视频分镜 prompt。
- [[domains/视觉制作/06-AI视频/30-影像美学大师风格AI短视频/04-是枝裕和风格AI短视频制作方法|是枝裕和风格AI短视频制作方法]]：把家庭日常、自然光、低戏剧化冲突、生活动作和温柔观察转成 AI 短视频分镜 prompt。
- [[domains/视觉制作/06-AI视频/30-影像美学大师风格AI短视频/05-小津安二郎风格AI短视频制作方法|小津安二郎风格AI短视频制作方法]]：把榻榻米低机位、静态构图、家庭秩序和空镜过渡转成 AI 短视频分镜 prompt。
- [[domains/视觉制作/06-AI视频/30-影像美学大师风格AI短视频/06-侯孝贤风格AI短视频制作方法|侯孝贤风格AI短视频制作方法]]：把静态长镜头、中远景观察、长焦空间、历史记忆和生活时间感转成 AI 短视频分镜 prompt。
- [[domains/视觉制作/06-AI视频/30-影像美学大师风格AI短视频/07-贾樟柯风格AI短视频制作方法|贾樟柯风格AI短视频制作方法]]：把县城现实、公共空间、DV 纪实质感、时代变迁和普通人行动转成 AI 短视频分镜 prompt。
- [[domains/视觉制作/06-AI视频/30-影像美学大师风格AI短视频/08-大卫芬奇风格AI短视频制作方法|大卫芬奇风格AI短视频制作方法]]：把低饱和冷色、精密构图、受控运镜、暗部细节和心理压迫转成 AI 短视频分镜 prompt。
- [[domains/视觉制作/06-AI视频/30-影像美学大师风格AI短视频/09-斯皮尔伯格风格AI短视频制作方法|斯皮尔伯格风格AI短视频制作方法]]：把儿童视角、温暖逆光、流畅场面调度和奇观揭示转成 AI 短视频分镜 prompt。
- [[domains/视觉制作/06-AI视频/30-影像美学大师风格AI短视频/10-克里斯托弗诺兰风格AI短视频制作方法|克里斯托弗诺兰风格AI短视频制作方法]]：把时间结构、大画幅、实拍物理感、宏大空间和倒计时压力转成 AI 短视频分镜 prompt。
