...
- [[domains/视觉制作/06-AI视频/01-项目定义与剧本/01-产品销售型短视频剧本双路线|产品销售型短视频剧本双路线]]：把以产品销售为目标的短视频分为产品介绍型 TVC 与情感故事软广，明确 A/V 双栏稿、文学剧本和分镜的边界。
...
- [[domains/视觉制作/06-AI视频/01-项目定义与剧本/04-AI品牌TVC的气质、视觉符号与产品登场|AI品牌TVC的气质、视觉符号与产品登场]]：从产品研究和广告任务建立气质、视觉证据与产品登场策略，并用确认门控制资产和视频生成。
...
- [[domains/视觉制作/06-AI视频/01-项目定义与剧本/06-AI短视频故事方法论|AI短视频故事方法论]]：融合短片编剧、广告创意、传播记忆、视觉结构、剪辑节奏和案例库，服务产品营销短视频广告与情感短片。
- [[domains/视觉制作/06-AI视频/01-项目定义与剧本/09-故事洞察与广告命题|故事洞察与广告命题]]：把产品事实、用户处境、人物任务和产品叙事功能压成可拍、可记忆的广告命题。
- [[domains/视觉制作/06-AI视频/01-项目定义与剧本/11-短故事结构与情绪推进|短故事结构与情绪推进]]：用短片戏剧原则和七步故事，把短视频组织为处境、缺口、关键行动、变化和余味。
- [[domains/视觉制作/06-AI视频/01-项目定义与剧本/10-人物动机阻碍与转变|人物动机阻碍与转变]]：把人物状态、想要、阻碍、代价、关键动作和片尾转变写成可拍字段。
- [[domains/视觉制作/06-AI视频/01-项目定义与剧本/12-创意记忆点与传播钩子|创意记忆点与传播钩子]]：用简单、意外、具体、可信、情绪和故事机制设计开头钩子、物件、动作和品牌收束。
- [[domains/视觉制作/06-AI视频/01-项目定义与剧本/19-视觉结构与剪辑节奏|视觉结构与剪辑节奏]]：把视觉强度、镜头问题/答案、切点和节奏转成 AI 短视频分镜规则。
- [[domains/视觉制作/06-AI视频/01-项目定义与剧本/07-产品营销短视频故事模式库|产品营销短视频故事模式库]]：把 OPPO、五菱、母亲节、意识残留、运动品牌、低度果酒和端午案例抽成可迁移故事模式。
- [[domains/视觉制作/06-AI视频/03-分镜脚本/40-AI故事到分镜生产工作流|AI故事到分镜生产工作流]]：把故事命题转成视觉事件、镜头问题/答案、分镜字段、首尾帧和声音边界。
- [[domains/视觉制作/06-AI视频/01-项目定义与剧本/17-Agent使用模板：AI短视频故事策划|Agent使用模板：AI短视频故事策划]]：给 Agent 完成故事命题、结构、镜头任务、生产交接和质检的标准输出模板。
